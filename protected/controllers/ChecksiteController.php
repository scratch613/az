...
class ChecksiteController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			array('allow', // allow authenticated user to perform 'create' and 'update' actions
				'actions'=>array('index', 'pause', 'release'),
				'users'=>array('@'),
			),
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('admin','delete', 'create', 'update', 'stop', 'cancel', 'rehash', 'rehashSoftly', ),
				'users'=>array('admin'),
			),
    ...
    public function actionRehash($id) {
        $model=$this->loadModel($id);
	    $model->rehash(true);
	    $this->redirect('/checksite/admin');
    }

    public function actionRehashSoftly($id) {
        $model=$this->loadModel($id);
        // Rehash auto-sets 'ok'
        $model->rehash();
        $this->redirect('/checksite/admin');
